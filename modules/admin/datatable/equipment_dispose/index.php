<div class="box">
    <div id="svcscont">
        <div id="eqpavail"> 
            <h2><img src="../../img/icon/equipmentsicon.png"> Disposed Equipments</h2>
        </div>
...
$(document).ready(function(){
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"datatable/equipment_dispose/fetch.php",
			method:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		{
			$.ajax({
				url:"datatable/equipment_dispose/insert.php",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		{
			$.ajax({
				url:"datatable/equipment_dispose/update_single_eqp.php",
				method:"POST",
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"datatable/equipment_dispose/dispose.php",
				method:"POST",
				data:{eqp_id:eqp_id},
				success:function(data)
				{
