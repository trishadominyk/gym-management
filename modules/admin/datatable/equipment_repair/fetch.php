...
{
	$query .= 'WHERE E.eqp_status = "REPAIR" AND (E.eqp_serial LIKE "%'.$_POST["search"]["value"].'%" OR  E.eqp_name LIKE "%'.$_POST["search"]["value"].'%")';

}else{
	$query .= 'WHERE E.eqp_status = "REPAIR" ORDER BY E.cat_id';
}
if($_POST["length"] != -1)
{
