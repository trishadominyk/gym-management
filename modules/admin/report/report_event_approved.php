...
class PDF extends FPDF{
    ...
    $this->Cell(200,15,'Approved Event',0,0,'C');
    $this->Ln();
	...
	function viewTable($connection){
		...
		$start = $_GET['start'];
		$end = $_GET['end'];
		$q = $connection->prepare('SELECT E.evn_name, ED.evn_det_date, ED.evn_det_time_start, ED.evn_det_time_end, ED.evn_det_venue  FROM tbl_event E LEFT OUTER JOIN tbl_eventdetail ED ON E.evn_id = ED.evn_id WHERE evn_det_date BETWEEN :start AND :end AND E.evn_status = "APPROVED" ORDER BY ED.evn_det_date');
