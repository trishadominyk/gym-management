	...
	<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a class="page-scroll" href="index.php?mod=client">Clients</a>
                            </li>
                            <li>
                                <a class="page-scroll" href="index.php?mod=logbook">Logbook</a>
                            </li>
                            <li>
                                <a class="page-scroll" href="index.php?mod=transaction">Sales</a>
                            </li>
                            <li>
                                <a class="page-scroll" href="index.php?mod=enroll">Enroll</a>
                            </li>
		...
		<div id="MAIN_CONTENT">
			<?php
				switch($module){
					case 'enroll':
						require_once 'datatable/enroll/index.php';
					break;
					case 'logbook':
						require_once 'datatable/logbook/index.php';
					break;
                    case 'transaction':
                        require_once 'datatable/transactions/index.php';
                    break;
                    case 'profile':
