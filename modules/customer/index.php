<?php
	...
	include '../../classes/class.logbook.php';
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a class="page-scroll" href="index.php?mod=logs">Logs & Progress</a>
                            </li>
		...
		<div id="MAIN_CONTENT">
			<?php
				switch($module){
					...
					break;
                    case 'settings':
                        require_once 'datatable/profile/settings.php';
                    break;
					case 'logs':
						require_once 'datatable/logs/index.php';
					break;
					default:
